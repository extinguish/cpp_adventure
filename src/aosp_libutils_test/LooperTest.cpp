...
//elapsedMillis = ns2ms(stopWatch.elapsedTime());
//
//EXPECT_NEAR(100 + 100, elapsedMillis, TIMING_TOLERANCE_MS) << "third poll should timeout";
//EXPECT_EQ(Looper::POLL_TIMEOUT, result)<< "pollOnce result should be Looper::POLL_TIMEOUT because there were no messages left";
//}
//
