...
#ifndef CPPADVENTURE_TIMERS_H
#define CPPADVENTURE_TIMERS_H
...
public:
    ...
    // the callback function of which using to handle times up function
    typedef int (*handleTimesUpAction)(void *clientPtr);
...
public:
    ...
    // timer_id create(uint64_t when, uint64_t period, handleTimesUpAction handleCallback);
