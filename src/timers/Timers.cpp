...
//Timer::timer_id Timer::create(uint64_t msFromNow, uint64_t msPeriod, handleTimesUpAction handleCallback) {
//    return createImpl(Instance(0, Clock::now() + Duration(msFromNow), Duration(msPeriod), handleCallback));
//}
