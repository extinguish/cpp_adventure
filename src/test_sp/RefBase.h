...
#ifndef C_ADVENTURE_REFBASE_H
#define C_ADVENTURE_REFBASE_H
...
// ---------------------------------------------------------------------------
    ...
    public:
        virtual
        size_t getReferenceTypeSize() const = 0;

        virtual
        void *getReferenceBase(void const *) const = 0;
...
// ---------------------------------------------------------------------------
    ...
    public:
        ...
        wp &operator=(const wp<T>
                      &other);

        wp &operator=(const sp<T>
                      &other);
        ...
        inline bool operator==(const wp<T>
                               &o) const {
        ...
        template<typename
        U>
        inline bool operator==(const wp<U>
                               &o) const {
